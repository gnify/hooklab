...
export type ConfigNames = 'hooklab/eslint-comments/rules' | 'hooklab/formatter/setup' | 'hooklab/imports/rules' | 'hooklab/javascript/setup' | 'hooklab/javascript/rules' | 'hooklab/jsx/setup' | 'hooklab/jsdoc/rules' | 'hooklab/jsonc/setup' | 'hooklab/jsonc/rules' | 'hooklab/markdown/setup' | 'hooklab/markdown/processor' | 'hooklab/markdown/parser' | 'hooklab/markdown/disables' | 'hooklab/node/rules' | 'hooklab/perfectionist/setup' | 'hooklab/react/setup' | 'hooklab/react/rules' | 'hooklab/sort/package-json' | 'hooklab/stylistic/rules' | 'hooklab/test/setup' | 'hooklab/test/rules' | 'hooklab/regexp/rules' | 'hooklab/typescript/setup' | 'antfu/typescript/parser' | 'hooklab/typescript/rules' | 'hooklab/unicorn/rules' | 'hooklab/yaml/setup' | 'hooklab/yaml/rules'
