...
export async function formatters(
  ...
  if (options.markdown) {
    ...
    configs.push({
      ...
      name: 'hooklab/formatter/markdown',
      rules: {
        [`format/${formater}`]: [
          'error',
          formater === 'prettier'
  ...
  if (options.graphql) {
    configs.push({
      ...
      name: 'hooklab/formatter/graphql',
      rules: {
        'format/prettier': [
          'error',
          mergePrettierOptions(prettierOptions, {
