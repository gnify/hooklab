...
function SheetOverlay({
  ...
  ref,
  ...props
}: ComponentPropsWithRef<typeof SheetPrimitive.Overlay>): JSX.Element {
  return (
...
function SheetTitle({
  ...
  ref,
  ...props
}: ComponentPropsWithRef<typeof SheetPrimitive.Title>): JSX.Element {
  return (
...
function SheetDescription({
  ...
  ref,
  ...props
}: ComponentPropsWithRef<typeof SheetPrimitive.Description>): JSX.Element {
  return (
